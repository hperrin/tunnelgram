<div style="display: flex; justify-content: center; align-items: center; position: relative; width: {width}px; height: {height}px;">
  ...
  {/if}
  <svg class="lds-dual-ring" width="{width * .9}px" height="{height * .9}px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" style="position: absolute; background: none;">
    <circle cx="50" cy="50" fill="none" stroke-linecap="round" r="48" stroke-width="4" stroke="#337ab7" stroke-dasharray={progress != null ? (progress * 301.593)+' '+(301.593 - (progress * 301.593)) : '75.398 75.398'} transform="rotate(99 50 50)">
